...
public class ThongTinActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        LatLng MobileShop = new LatLng(10.791018613788042, 106.68188459851856);
        mMap.addMarker(new MarkerOptions().position(MobileShop).title("MoBileShop Xin Chào").snippet("Cao Đẳng Thực Hành FPT").icon(BitmapDescriptorFactory.defaultMarker(BitmapDescriptorFactory.HUE_GREEN)));
       mMap.setMapType(GoogleMap.MAP_TYPE_NORMAL);
        mMap.moveCamera(CameraUpdateFactory.newLatLng(MobileShop));
        CameraPosition cameraPosition = new CameraPosition.Builder().target(MobileShop).zoom(90).build();
